...
export function seedDb() {
  ...
  const users = [
    { id: "usr_1", type: "RUT", identifier: "123456785", password: "123456", name: "Lauryn", blocked: 0 },
    { id: "usr_2", type: "EMAIL", identifier: "qa@demo.cl", password: "123456", name: "QA Demo", blocked: 0 },
    { id: "usr_3", type: "RUT", identifier: "111111111", password: "123456", name: "chimuela", blocked: 0 },
